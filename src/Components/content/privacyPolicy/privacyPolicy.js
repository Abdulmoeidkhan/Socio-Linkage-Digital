    ...
    <Content>
        <div style={{ margin: '0px 16px' }}>
            ...
            <section>
                ...
                <h4 id="PP1">1. WHAT INFORMATION DO WE COLLECT?</h4>
                ...
                <h4 id="PP2">2.  HOW DO WE USE YOUR INFORMATION?</h4>
                <p>
                    <strong>
                        In Short:
                        </strong>
                ...
                <h4 id="PP3">3.  WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h4>
                <p>
                    <strong>
                        In Short:
                        </strong>
                ...
                <h4 id="PP4">4.  WHO WILL YOUR INFORMATION BE SHARED WITH?</h4>
                <p>
                    <strong>
                        In Short:
                        </strong>
                        ...
                        <li>
                            ...
                            <p>Google Sign-In, Facebook Login and Firebase Authentication</p>
                        </li>
                        <li>
                            <strong>
                ...
                <h4 id="PP5">5.  DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h4>
                <p>
                    <strong>In Short:</strong>
                ...
                <h4 id="PP6">6.  DO WE USE GOOGLE MAPS?</h4>
                <p>
                    <strong>In Short:</strong>
                ...
                <h4 id="PP7">7. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h4>
                <p>
                <strong>In Short:</strong>
                ...
                <h4 id="PP8">8. HOW LONG DO WE KEEP YOUR INFORMATION?</h4>
                <p>
                <strong>In Short:</strong>
                ...
                <h4 id="PP9">9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h4>
                <p>
                <strong>In Short:</strong>
                ...
                <h4 id="PP10">10. WHAT ARE YOUR PRIVACY RIGHTS?</h4>
                <p>
                <strong>In Short:</strong>
                ...
                <h4 id="PP11">11. CONTROLS FOR DO-NOT-TRACK FEATURES</h4>
                <p>
                ...
                <h4 id="PP12">12. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h4>
                <p>
                <strong>In Short:</strong>
                ...
                <h4 id="PP13">13. DO WE MAKE UPDATES TO THIS NOTICE?</h4>
                <p>
                <strong>In Short:</strong>
                ...
                <h4 id="PP14">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h4>
                <p>
